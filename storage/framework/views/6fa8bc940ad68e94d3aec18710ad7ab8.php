            ...
            <table class="table">
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="https://themewagon.github.io/celestialAdmin-free-admin-template/images/faces/face30.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="https://themewagon.github.io/celestialAdmin-free-admin-template/images/faces/face31.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="https://themewagon.github.io/celestialAdmin-free-admin-template/images/faces/face32.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="https://themewagon.github.io/celestialAdmin-free-admin-template/images/faces/face33.png" alt="profile image">
                      <div>
                        <div> Company</div>
                        <div class="font-weight-bold  mt-1">Morgan </div>
                      </div>
                    </div>
                  </td>http://127.0.0.1:8000/dashboard#error
                  <td>
                    Budget
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="https://themewagon.github.io/celestialAdmin-free-admin-template/images/faces/face34.png" alt="profile image">
                      <div>
                        <div> Company</div>
                        <div class="font-weight-bold  mt-1">volkswagen</div>
                      </div>
...
<footer class="footer">
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    <span class="text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://www.bootstrapdash.com/" target="_blank">bootstrapdash.com</a> 2020<br><br>
...
<?php echo $__env->make('admin/layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\arvitaagusk\resources\views/Admin/dashboard.blade.php ENDPATH**/ ?>