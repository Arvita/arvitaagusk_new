...
<head>
    ...
    <link href="<?php echo e(asset('frontend/assets/css/bootstrap.css')); ?>" rel="stylesheet" type="text/css">

    <!-- color css -->

    <link href="<?php echo e(asset('frontend/assets/css/color-8.css')); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo e(asset('frontend/assets/css/keyframes.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo e(asset('frontend/assets/css/fontawesome.css')); ?>" rel="stylesheet" type="text/css">

    <link href="<?php echo e(asset('frontend/assets/css/themify.css')); ?>" rel="stylesheet" type="text/css">



    <!-- flat Icons -->

    <link href="<?php echo e(asset('frontend/assets/css/flaticon.css')); ?>" rel="stylesheet" type="text/css">
...
<body class="">
    ...
    <section class="saas1 header" id="home">
                                ...
                                <div class="header-text">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="center-content slider-logo">
                                            ...
                                            <img alt="" class="img-fluid" src="<?php echo e(asset('frontend/assets/images/saas1/slider-logo.png')); ?>">
                                ...
                                <div class="link-horizontal">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a class="btn btn-default primary-btn transparent" href="https://www.youtube.com/channel/UCU5lYacwXkUkYaX6AZ1WnGQ?app=desktop">watch youtube<img alt="video-icon" class="m-l-5" src="<?php echo e(asset('frontend/assets/images/saas1/video-icon.png')); ?>"></a>
                        ...
                        <div class="center-text slider-banner">
                            ...
                            <div class="owl-carousel owl-theme overflow-hidden slider-1">
                                ...
                                <div class="item">
                                    ...
                                    <img alt="slid-banner" src="<?php echo e(asset('frontend/assets/images/saas1/arvita.png')); ?>">
        ...
        <img alt="" class="img-fluid set-abs background" src="<?php echo e(asset('frontend/assets/images/saas1/background2.png')); ?>">

        <img alt="" class="img-fluid set-abs dot" src="<?php echo e(asset('frontend/assets/images/saas1/dot.png')); ?>">
    ...
    <script src="<?php echo e(asset('frontend/assets/js/video-popup.js')); ?>"></script>

    <script src="<?php echo e(asset('frontend/assets/js/script8.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\arvitaagusk\resources\views/frontend/layouts/template.blade.php ENDPATH**/ ?>